...
namespace SportsApp
{
    public partial class aussieRules : Form
    {
        public aussieRules()
        {
            InitializeComponent();
        ...
        private List<sportsApi.Root> footy = new List<sportsApi.Root> { };
        ...
        private void aussieRules_Load(object sender, EventArgs e)
        {
        ...
        private void comboBoxLeagues_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            foreach (sportsApi.Root key in footy)
            {

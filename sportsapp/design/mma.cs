...
namespace SportsApp
{
    public partial class mma : Form
    {
        ...
        private List<sportsApi.Root> mmaSport = new List<sportsApi.Root> { };
        ...
        private void mma_Load(object sender, EventArgs e)
        {
        ...
        private void comboBoxLeagues_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            foreach (sportsApi.Root key in mmaSport)
            {

...
namespace SportsApp
{
    public partial class football : Form
    {
        ...
        private List<sportsApi.Root> footballSport = new List<sportsApi.Root> { };
        ...
        private void comboBoxLeagues_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            foreach (sportsApi.Root key in footballSport)
            {
        ...
        private void dataGridMatches_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

...
namespace SportsApp
{
    public partial class cricket : Form
    {
        ...
        private List<sportsApi.Root> cricketSport = new List<sportsApi.Root> { };
        ...
        private void cricket_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (sport.group == "Cricket")
                    {
                        cricketSport.Add(sport);
        ...
        private void comboBoxLeagues_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            foreach (sportsApi.Root key in cricketSport)
            {
